...
function CheckoutForm({
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    if (confirmError) {
      ...
      // Clear cart before redirect (belt-and-suspenders with success page)
      clearCart();
...
export default function CheckoutModal({ isOpen, onClose }: CheckoutModalProps) {
  ...
  // Fetch clientSecret when modal opens
  const handleOpen = useCallback(() => {
    if (!clientSecret) {
      initCheckout();
    }
  }, [clientSecret, initCheckout]);
        ...
        <>
          ...
          >
            ...
            {fetchError ? (
              ...
              >
                <CheckoutForm onClose={handleClose} total={totalPrice} />
              </Elements>
            )}
          </motion.div>
        </>
